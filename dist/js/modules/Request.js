...
exports.default = {
    async new(func, code, options, uglifier_options, clientSession) {
        ...
        return await fetch(`${options.api_url()}${func.value}`, { method: "POST", body: code, credentials: "omit", headers: { "uglifier-options": JSON.stringify(uglifier_options), "uglifier-session": clientSession } }).catch(error => {
            const _error = error;
